...
pub trait YaDeserialize: Sized {
  fn deserialize<P: crate::xml::XmlEventReader>(
...
pub trait YaSerialize: Sized {
  ...
  fn serialize_attributes(
    &self,
    attributes: Vec<crate::xml::XmlAttribute>,
    namespace: crate::xml::XmlNamespace,
  ) -> Result<(Vec<crate::xml::XmlAttribute>, crate::xml::XmlNamespace), String>;
}
...
/// Compatibility facade for code generated by yaserde_derive and older custom code.
#[doc(hidden)]
pub mod __xml {
  pub mod reader {
    pub use crate::xml::XmlReadEvent as XmlEvent;
  }

  pub mod name {
    pub use crate::xml::XmlName as OwnedName;
  }

  pub mod attribute {
    pub use crate::xml::XmlAttribute as OwnedAttribute;
  }

  pub mod namespace {
    pub use crate::xml::XmlNamespace as Namespace;
  }

  pub mod writer {
    pub use ::xml::writer::EventWriter;
  }
}
